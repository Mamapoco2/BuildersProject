    ...
    <main className="bg-stone-950 pt-20">
      ...
      <section ref={heroRef} className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            320+ completed projects across the Philippines. Each one a testament
            to precision engineering and reliable delivery.
          </p>
        </div>
      </section>
...
function ProjectCard({ project, onOpen }) {
  ...
  return (
    <div
      ref={cardRef}
      className="proj-card group bg-stone-900 border border-stone-800 rounded-lg overflow-hidden hover:border-red-500/30 transition-colors cursor-pointer"
      onClick={onOpen}
    ...
    >
      ...
      <div className="p-6">
        ...
        <h3 className="font-heading font-bold text-xl text-white mb-3 group-hover:text-red-400 transition-colors">
          {project.title}
        </h3>
        ...
        <div className="mt-4 pt-4 border-t border-stone-800 flex items-center gap-2 text-red-500/60 group-hover:text-red-500 text-sm font-heading font-semibold tracking-wider uppercase transition-colors">
          View Details{" "}
    ...
    <>
      <DialogHeader>
        ...
        <p className="text-stone-400 text-sm flex items-center gap-2 mt-1">
          <MapPin className="w-4 h-4 text-red-500" /> {project.location}
        </p>
      </DialogHeader>
