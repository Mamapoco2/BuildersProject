...
const contactInfo = [
  {
    icon: MapPin,
    label: "Head Office",
    value: "12F GT Tower, Ayala Ave, Makati City, 1226",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+63 2 8345 6789",
    href: "tel:+63283456789",
  },
  {
    icon: Mail,
    label: "Email",
    value: "hello@buildcraft.ph",
    ...
    <main className="bg-stone-950 pt-20">
      ...
      <section ref={heroRef} className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Have a project in mind? Our team is ready to discuss your
          ...
          <div className="grid lg:grid-cols-5 gap-10">
              ...
              <div className="bg-stone-900 border border-stone-800 rounded-xl p-7 space-y-5">
                ...
                {contactInfo.map(({ icon: Icon, label, value, href }) => (
                  <div key={label} className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-red-500/10 border border-red-500/20 rounded-sm flex items-center justify-center shrink-0">
                      <Icon className="w-5 h-5 text-red-500" />
                    </div>
                    <div>
                      <div className="font-heading font-semibold text-sm text-stone-400 tracking-widest uppercase mb-0.5">
                        {label}
                      </div>
                      {href ? (
                        <a
              ...
              <div className="bg-stone-900 border border-stone-800 rounded-xl p-7">
                ...
                <div className="space-y-4">
                  {offices.map((o) => (
                    <div
                      key={o.city}
                      className="flex items-center justify-between border-b border-stone-800 pb-4 last:border-0 last:pb-0"
                    >
                      <div>
            ...
            <div className="lg:col-span-3">
              {!submitted ? (
                <div
                  ref={formRef}
                  className="bg-stone-900 border border-stone-800 rounded-xl p-8"
                >
                  <h2
                  ...
                  >
                    ...
                    <div data-f>
                      ...
                      <select
                        ...
                        className="flex h-11 w-full rounded-md border border-stone-700 bg-stone-800/50 px-4 py-2 text-sm text-stone-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:border-red-500 transition-all"
                      >
                ...
                <div className="success-msg flex flex-col items-center justify-center text-center bg-stone-900 border border-stone-800 rounded-xl p-16 h-full min-h-100">
