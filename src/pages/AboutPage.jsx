    ...
    <main className="bg-stone-950 pt-20">
      ...
      <section ref={heroRef} className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div data-a className="inline-flex items-center gap-2 text-orange-500 mb-4">
            ...
            <span className="font-heading font-semibold text-sm tracking-widest uppercase">About Us</span>
          </div>
          ...
          <p data-a className="text-stone-300 text-xl max-w-2xl leading-relaxed">
            For 25 years, BuildCraft has been the construction partner that developers, government agencies, and private clients rely on when the stakes are highest.
          </p>

          {/* Stats */}
          <div data-a className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 pt-10 border-t border-stone-800/60">
            {stats.map(({ value, label }) => (
              <div key={label}>
                <div className="font-display text-4xl lg:text-5xl text-orange-500 tracking-wider">{value}</div>
                <div className="font-heading text-stone-400 text-sm tracking-widest uppercase mt-1">{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-stone-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader eyebrow="What We Stand For" title="Mission, Vision" accent="& Values" center={false} className="mb-14" />
          ...
          <div ref={mvRef} className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div data-mv key={label} className="bg-stone-900 border border-stone-800 rounded-lg p-8 hover:border-orange-500/30 transition-colors">
                ...
                <h3 className="font-heading font-bold text-2xl text-white mb-3">{label}</h3>
      ...
      <section className="py-24 bg-stone-950">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader eyebrow="Our Journey" title="Company" accent="History" className="mb-16" />
                ...
                >
                  ...
                  <div className={`ml-14 md:ml-0 md:w-[calc(50%-2rem)] ${i % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                    <div className="bg-stone-900 border border-stone-800 rounded-lg p-6 hover:border-orange-500/30 transition-colors">
                      <span className="font-display text-3xl text-orange-500 tracking-wider">{item.year}</span>
      ...
      <section id="team" className="py-24 bg-stone-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader eyebrow="The People" title="Our Leadership" accent="Team" className="mb-14" />
            ...
            {team.map((member) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="text-orange-500 text-xs font-heading font-semibold tracking-widest uppercase mt-1 mb-3">{member.role}</div>
