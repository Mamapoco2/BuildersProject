    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="max-w-3xl">
          ...
          <p
            ref={subRef}
            className="text-stone-300 text-lg sm:text-xl leading-relaxed max-w-xl mb-10"
          >
            From ground-breaking to grand opening — BuildCraft delivers complex
            construction with precision, speed, and integrity across the
            Philippines.
          </p>
      ...
      {/* Diagonal cut */}
      <div
        className="absolute bottom-0 left-0 right-0 h-16 bg-stone-950 z-20"
