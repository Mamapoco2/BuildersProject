        ...
        <div ref={headRef} className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 text-orange-500">
              ...
              <span className="font-heading font-semibold text-sm tracking-widest uppercase">Our Work</span>
            </div>
...
function ProjectCard({ project, large }) {
  ...
  return (
    ...
    >
      ...
      {/* Hover overlay */}
      <div ref={overlayRef} className="absolute inset-0 bg-orange-500/10 opacity-0" />

      {/* Content */}
      <div className="absolute inset-0 p-6 flex flex-col justify-end">
        <Badge variant="secondary" className="self-start mb-3 text-xs">{project.category}</Badge>
        ...
        <Link
          to="/projects"
          className="inline-flex items-center gap-2 font-heading font-semibold text-orange-400 text-sm tracking-wider uppercase opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300"
        >
